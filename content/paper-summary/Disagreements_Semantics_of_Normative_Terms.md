...
* Traditional metaethical arguments that rely on disagreement intuitions (like Hare’s) lose their force.
* Contextual or speaker-relative semantic theories can still make sense of disagreement.
* Metaethics should stop using disagreement intuitions as quick refutations.
...
(a) “There is one proton in a helium nucleus.”
(b) “No, there are two.”
...
Implications:
* Genuine disagreement can coexist with meaning variation.
* Disagreement alone cannot justify inferring shared meaning.
* Contextualist or relativist theories can accommodate disagreement.
* The *Shared Meaning Task* in metaethics is misguided.
...
* Disagreement intuitions alone cannot establish shared meaning.
* Many normative and evaluative disputes are non-canonical.
* This rescues contextualist and relativist views from standard objections.
* The assumption of shared meaning in metaethics may be mistaken.
* Speakers can mean different things while genuinely disagreeing.
