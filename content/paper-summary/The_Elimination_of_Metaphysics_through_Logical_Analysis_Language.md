...
**Short Abstract:**
In this paper Rudolf Carnap argues that all talk about metaphysics is meaningless.
...
2. Under what conditions is *s* supposed to be true or false?
...
Carnap regards metaphysics not as mere speculation or fairy tale.
Statements in fairy tales do not conflict with logic, only with experience; fairy tales are perfectly meaningful even though they are false.
...
Four Criticisms:
1. He says something like “all metaphysics is meaningless,” but this statement is self-defeating, because all philosophy presupposes metaphysics. For example, Carnap relies on logic. But there are different logical systems (e.g. fuzzy logic). His choice to use classical logic is itself a metaphysical choice.
2. When he lists the criteria for what a statement needs in order to have meaning, one of them is that it must be falsifiable. This is the famous criterion introduced to determine whether something is scientific. However, even the author Karl Popper later admitted that his criterion is not perfect and may already exclude theories that could still be considered scientific. Carnap, by adding further criteria, makes it even stricter.
3. The criteria for falsifiable for scientific theories was invented for scientific theories, but metaphysics is not science. Science tells you how things relate to each other, it is a prediticive model, if I do this then this happens, this is obvious by how we do science, we do experiment where we look what happens when we do a particular action. For example newton theory of gravity does not tell us what gravity *is*, it tells us how two objects with mass relate to each other i.e. they attract each other. One could say science is neutral towards what thing are really made out of. Metaphysics on the other hands is not a prediticive model, it does not tell us how things relate to each other, it tells us what things *are*, phsyicalism tells us things *are* matter i.e. physical quantities, idealism tells us thing *are* mental. As such they are different diciplines and the falsifiable criteria cannot be directly transferred from science to metaphysics.
5. Wittgenstein says that the meaning of language arises from its usage. If we talk about religion, God, or metaphysics as if these have meaning, then whatever that meaning is, it must include metaphysics, simply because of how the words are used.
6. When Carnap criticizes Heidegger’s sentence about “nothing,” he analyzes it logically. This is misguided, because even Heidegger himself admits that it is not a logical statement. Rather, whenever we have a theory or system that breaks down, it reveals an aspect we had not accounted. For example, Newtonian gravity giving way to Einsteinian gravity. Heidegger does something similar: his sentence is meant to be illogical, because it demonstrates the limits of language itself, pointing toward an aspect that cannot be captured by language.
