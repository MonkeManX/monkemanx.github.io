...
<figure>
    ...
    <figcaption>"An exemplary view of the Calibre-Web software.</figcaption>
</figure>
...
<figure>
    ...
    <figcaption>Example of a docker command to run a container.</figcaption>
</figure>
...
5. After installation, check the container status by running:
	...
	docker ps -a
	```
	You should see something similar to the provided image.
    <figure>
        <img style="display: block; margin-left: auto; margin-right: auto; width:100%" src="/attachments//Screenshot%20from%202024-01-19%2017-55-17.png">
    </figure>
