...
{{< info "Info" >}}
In this post, I provide examples with the PaperMod theme. While this method works, I no longer use this theme on my website. Many things in this post will also apply to other themes.
{{< /info >}}
...
<figure>
    ...
    <figcaption><a href="https://github.com/adityatelange/hugo-PaperMod">Source</a></figcaption>
</figure>
